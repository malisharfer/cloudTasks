...
function Ae(a, r) {
    if (r(a))
        return a;
    if (a.parentNode)
        return Ae(a.parentNode, r)
}
function se(a, r) {
    var e = y("div", "numInputWrapper")
      , c = y("input", "numInput " + a)
      , u = y("span", "arrowUp")
      , h = y("span", "arrowDown");
    if (navigator.userAgent.indexOf("MSIE 9.0") === -1 ? c.type = "number" : (c.type = "text",
    c.pattern = "\\d*"),
    r !== void 0)
        for (var D in r)
            c.setAttribute(D, r[D]);
...
var Ne = function() {}
  ...
  , Ge = {
    ...
    W: function(a, r, e) {
        var c = parseInt(r)
          , u = new Date(a.getFullYear(),0,2 + (c - 1) * 7,0,0,0,0);
        return u.setDate(u.getDate() - u.getDay() + e.firstDayOfWeek),
        u
    },
    Y: function(a, r) {
    ...
    return function(h, D, w, p) {
        if (!(h !== 0 && !h)) {
            ...
            if (h instanceof Date)
                k = new Date(h.getTime());
            else if (typeof h != "string" && h.toFixed !== void 0)
                k = new Date(h);
            else if (typeof h == "string") {
                var I = D || (e || z).dateFormat
                  , P = String(h).trim();
                if (P === "today")
                    k = new Date,
                    w = !0;
                    ...
                    k = !e || !e.noCalendar ? new Date(new Date().getFullYear(),0,1,0,0,0,0) : new Date(new Date().setHours(0, 0, 0, 0)),
                    M.forEach(function($) {
                        var B = $.fn
                          , Q = $.val;
                        return k = B(k, Q, F) || k
...
function j(a, r, e) {
    return e === void 0 && (e = !0),
    e !== !1 ? new Date(a.getTime()).setHours(0, 0, 0, 0) - new Date(r.getTime()).setHours(0, 0, 0, 0) : a.getTime() - r.getTime()
}
...
function xe(a) {
    var r = a.defaultHour
      ...
      , c = a.defaultSeconds;
    if (a.minDate !== void 0) {
        var u = a.minDate.getHours()
          , h = a.minDate.getMinutes()
          , D = a.minDate.getSeconds();
        r < u && (r = u),
        r === u && e < h && (e = h),
        r === u && e === h && c < D && (c = a.minDate.getSeconds())
    }
    if (a.maxDate !== void 0) {
        var w = a.maxDate.getHours()
          , p = a.maxDate.getMinutes();
        r = Math.min(r, w),
        r === w && (e = Math.min(p, e)),
        r === w && e === p && (c = a.maxDate.getSeconds())
    }
    return {
        hours: r,
        minutes: e,
...
var A = function() {
  ...
  , en = function() {
    ...
    for (var c = Array(a), u = 0, r = 0; r < e; r++)
        for (var h = arguments[r], D = 0, w = h.length; D < w; D++,
        u++)
            c[u] = h[D];
    return c
}
...
function Rn(a, r) {
    ...
    e.loadedPlugins = [],
    e._bind = M,
    e._setHoursFromDate = I,
    e._positionCalendar = he,
    e.changeMonth = Ee,
    e.changeYear = de,
    e.clear = dn,
    e.close = mn,
    ...
    function c() {
        e.utils = {
            getDaysInMonth: function(n, t) {
                return n === void 0 && (n = e.currentMonth),
                t === void 0 && (t = e.currentYear),
                n === 1 && (t % 4 === 0 && t % 100 !== 0 || t % 400 === 0) ? 29 : e.l10n.daysInMonth[n]
            }
        }
    }
    function u() {
        ...
        e.isMobile || N(),
        ae(),
        (e.selectedDates.length || e.config.noCalendar) && (e.config.enableTime && I(e.config.noCalendar ? e.latestSelectedDateObj : void 0),
        J(!1)),
        w();
    ...
    function w() {
        ...
        n.weekNumbers === !1 && n.showMonths === 1 || n.noCalendar !== !0 && window.requestAnimationFrame(function() {
            ...
            e.daysContainer !== void 0) {
                ...
                e.calendarContainer.style.width = t + (e.weekWrapper !== void 0 ? e.weekWrapper.offsetWidth : 0) + "px",
    ...
    function p(n) {
        ...
        _(),
        J(),
        e._input.value !== o && e._debouncedChange()
    }
    function F(n, t) {
        ...
        if (!(e.hourElement === void 0 || e.minuteElement === void 0)) {
            ...
            if (e.config.maxTime !== void 0 && e.config.minTime !== void 0 && e.config.minTime > e.config.maxTime) {
                ...
                if (l) {
                    ...
                    n = Math.min(n, f.getHours()),
                    n === f.getHours() && (t = Math.min(t, f.getMinutes())),
                    t === f.getMinutes() && (i = Math.min(i, f.getSeconds()))
                }
                if (o) {
                    var g = e.config.minTime !== void 0 ? e.config.minTime : e.config.minDate;
                    n = Math.max(n, g.getHours()),
                    n === g.getHours() && t < g.getMinutes() && (t = g.getMinutes()),
                    t === g.getMinutes() && (i = Math.max(i, g.getSeconds()))
                }
            }
            P(n, t, i)
        }
    ...
    function P(n, t, i) {
        e.latestSelectedDateObj !== void 0 && e.latestSelectedDateObj.setHours(n % 24, t, i || 0, 0),
        !(!e.hourElement || !e.minuteElement || e.isMobile) && (e.hourElement.value = O(e.config.time_24hr ? n : (12 + n) % 12 + 12 * H(n % 12 === 0)),
        e.minuteElement.value = O(t),
        e.amPM !== void 0 && (e.amPM.textContent = e.l10n.amPM[H(n >= 12)]),
        e.secondElement !== void 0 && (e.secondElement.value = O(i)))
    }
    function K(n) {
        var t = L(n)
    ...
    function ae() {
        ...
        var n = Ye(pn, 50);
        if (e._debouncedChange = Ye(q, jn),
        e.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && M(e.daysContainer, "mouseover", function(i) {
            e.config.mode === "range" && ge(L(i))
        }),
        M(e._input, "keydown", We),
        e.calendarContainer !== void 0 && M(e.calendarContainer, "keydown", We),
        !e.config.inline && !e.config.static && M(window, "resize", n),
        window.ontouchstart !== void 0 ? M(window.document, "touchstart", Se) : M(window.document, "mousedown", Se),
        M(window.document, "focus", Se, {
            capture: !0
        }),
        e.config.clickOpens === !0 && (M(e._input, "focus", e.open),
        M(e._input, "click", e.open)),
        e.daysContainer !== void 0 && (M(e.monthNav, "click", Tn),
        M(e.monthNav, ["keyup", "increment"], K),
        M(e.daysContainer, "click", Je)),
        e.timeContainer !== void 0 && e.minuteElement !== void 0 && e.hourElement !== void 0) {
            var t = function(i) {
                return L(i).select()
            };
            M(e.timeContainer, ["increment"], p),
            M(e.timeContainer, "blur", p, {
                capture: !0
            }),
            M(e.timeContainer, "click", b),
            M([e.hourElement, e.minuteElement], ["focus", "click"], t),
            e.secondElement !== void 0 && M(e.secondElement, "focus", function() {
    ...
    function m(n, t) {
        var i = n !== void 0 ? e.parseDate(n) : e.latestSelectedDateObj || (e.config.minDate && e.config.minDate > e.now ? e.config.minDate : e.config.maxDate && e.config.maxDate < e.now ? e.config.maxDate : e.now)
          ...
          , l = e.currentMonth;
        try {
            i !== void 0 && (e.currentYear = i.getFullYear(),
            e.currentMonth = i.getMonth())
        } catch (s) {
            s.message = "Invalid date supplied: " + i,
            e.config.errorHandler(s)
        }
        t && e.currentYear !== o && (S("onYearChange"),
        X()),
        t && (e.currentYear !== o || e.currentMonth !== l) && S("onMonthChange"),
        e.redraw()
    }
    function b(n) {
        var t = L(n);
    ...
    function N() {
        ...
        if (e.calendarContainer = y("div", "flatpickr-calendar"),
        ...
        !e.config.noCalendar) {
            ...
            e.rContainer.appendChild(je()),
            e.daysContainer || (e.daysContainer = y("div", "flatpickr-days"),
        ...
        e.config.enableTime && n.appendChild(cn()),
        Y(e.calendarContainer, "rangeMode", e.config.mode === "range"),
        Y(e.calendarContainer, "animate", e.config.animate === !0),
        Y(e.calendarContainer, "multiMonth", e.config.showMonths > 1),
        ...
        e.config.inline && (!l && e.element.parentNode ? e.element.parentNode.insertBefore(e.calendarContainer, e._input.nextSibling) : e.config.appendTo !== void 0 && e.config.appendTo.appendChild(e.calendarContainer)),
        e.config.static)) {
            var s = y("div", "flatpickr-wrapper");
            e.element.parentNode && e.element.parentNode.insertBefore(s, e.element),
            s.appendChild(e.element),
            e.altInput && s.appendChild(e.altInput),
            s.appendChild(e.calendarContainer)
        }
        !e.config.static && !e.config.inline && (e.config.appendTo !== void 0 ? e.config.appendTo : window.document.body).appendChild(e.calendarContainer)
    }
    function W(n, t, i, o) {
        var l = G(t, !0)
          , s = y("span", n, t.getDate().toString());
        return s.dateObj = t,
        s.$i = o,
        s.setAttribute("aria-label", e.formatDate(t, e.config.ariaDateFormat)),
        n.indexOf("hidden") === -1 && j(t, e.now) === 0 && (e.todayDateElem = s,
        s.classList.add("today"),
        s.setAttribute("aria-current", "date")),
        l ? (s.tabIndex = -1,
        _e(t) && (s.classList.add("selected"),
        e.selectedDateElem = s,
        e.config.mode === "range" && (Y(s, "startRange", e.selectedDates[0] && j(t, e.selectedDates[0], !0) === 0),
        Y(s, "endRange", e.selectedDates[1] && j(t, e.selectedDates[1], !0) === 0),
        n === "nextMonthDay" && s.classList.add("inRange")))) : s.classList.add("flatpickr-disabled"),
        e.config.mode === "range" && Sn(t) && !_e(t) && s.classList.add("inRange"),
        e.weekNumbers && e.config.showMonths === 1 && n !== "prevMonthDay" && o % 7 === 6 && e.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + e.config.getWeek(t) + "</span>"),
        S("onDayCreate", s),
        s
    }
    function $(n) {
        n.focus(),
        e.config.mode === "range" && ge(n)
    }
    function B(n) {
        for (var t = n > 0 ? 0 : e.config.showMonths - 1, i = n > 0 ? e.config.showMonths : -1, o = t; o != i; o += n)
            for (var l = e.daysContainer.children[o], s = n > 0 ? 0 : l.children.length - 1, v = n > 0 ? l.children.length : -1, d = s; d != v; d += n) {
                var C = l.children[d];
                if (C.className.indexOf("hidden") === -1 && G(C.dateObj))
                    return C
            }
    }
    function Q(n, t) {
        for (var i = n.className.indexOf("Month") === -1 ? n.dateObj.getMonth() : e.currentMonth, o = t > 0 ? e.config.showMonths : -1, l = t > 0 ? 1 : -1, s = i - e.currentMonth; s != o; s += l)
            for (var v = e.daysContainer.children[s], d = i - e.currentMonth === s ? n.$i + t : t < 0 ? v.children.length - 1 : 0, C = v.children.length, f = d; f >= 0 && f < C && f != (t > 0 ? C : -1); f += l) {
                var g = v.children[f];
                if (g.className.indexOf("hidden") === -1 && G(g.dateObj) && Math.abs(n.$i - f) >= Math.abs(t))
                    return $(g)
            }
        e.changeMonth(l),
        re(B(l), 0)
    ...
    function ln(n, t) {
        for (var i = (new Date(n,t,1).getDay() - e.l10n.firstDayOfWeek + 7) % 7, o = e.utils.getDaysInMonth((t - 1 + 12) % 12, n), l = e.utils.getDaysInMonth(t, n), s = window.document.createDocumentFragment(), v = e.config.showMonths > 1, d = v ? "prevMonthDay hidden" : "prevMonthDay", C = v ? "nextMonthDay hidden" : "nextMonthDay", f = o + 1 - i, g = 0; f <= o; f++,
        g++)
            s.appendChild(W("flatpickr-day " + d, new Date(n,t - 1,f), f, g));
        for (f = 1; f <= l; f++,
        g++)
            s.appendChild(W("flatpickr-day", new Date(n,t,f), f, g));
        for (var E = l + 1; E <= 42 - i && (e.config.showMonths === 1 || g % 7 !== 0); E++,
        g++)
            s.appendChild(W("flatpickr-day " + C, new Date(n,t + 1,E % l), E, g));
    ...
    function fe() {
        if (e.daysContainer !== void 0) {
            le(e.daysContainer),
            e.weekNumbers && le(e.weekNumbers);
            for (var n = document.createDocumentFragment(), t = 0; t < e.config.showMonths; t++) {
                var i = new Date(e.currentYear,e.currentMonth,1);
                i.setMonth(e.currentMonth + t),
                n.appendChild(ln(i.getFullYear(), i.getMonth()))
            }
            e.daysContainer.appendChild(n),
            e.days = e.daysContainer.firstChild,
            e.config.mode === "range" && e.selectedDates.length === 1 && ge()
        }
    }
    function X() {
        if (!(e.config.showMonths > 1 || e.config.monthSelectorType !== "dropdown")) {
            ...
            for (var t = 0; t < 12; t++)
                if (n(t)) {
                    ...
                    i.value = new Date(e.currentYear,t).getMonth().toString(),
                    i.textContent = ue(t, e.config.shorthandCurrentMonth, e.l10n),
                    i.tabIndex = -1,
                    e.currentMonth === t && (i.selected = !0),
    ...
    function sn() {
        ...
        e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? i = y("span", "cur-month") : (e.monthsDropdownContainer = y("select", "flatpickr-monthDropdown-months"),
        e.monthsDropdownContainer.setAttribute("aria-label", e.l10n.monthAriaLabel),
        M(e.monthsDropdownContainer, "change", function(v) {
            var d = L(v)
              , C = parseInt(d.value, 10);
            e.changeMonth(C - e.currentMonth),
            S("onMonthChange")
        }),
        X(),
        ...
        l.setAttribute("aria-label", e.l10n.yearAriaLabel),
        e.config.minDate && l.setAttribute("min", e.config.minDate.getFullYear().toString()),
        e.config.maxDate && (l.setAttribute("max", e.config.maxDate.getFullYear().toString()),
        l.disabled = !!e.config.minDate && e.config.minDate.getFullYear() === e.config.maxDate.getFullYear());
    ...
    function un() {
        return e.monthNav = y("div", "flatpickr-months"),
        e.yearElements = [],
        e.monthElements = [],
        ...
        Object.defineProperty(e, "_hidePrevMonthArrow", {
            ...
            set: function(n) {
                e.__hidePrevMonthArrow !== n && (Y(e.prevMonthNav, "flatpickr-disabled", n),
        ...
        Object.defineProperty(e, "_hideNextMonthArrow", {
            ...
            set: function(n) {
                e.__hideNextMonthArrow !== n && (Y(e.nextMonthNav, "flatpickr-disabled", n),
    ...
    function cn() {
        ...
        var o = se("flatpickr-minute", {
            "aria-label": e.l10n.minuteAriaLabel
        });
        if (e.minuteElement = o.getElementsByTagName("input")[0],
        e.hourElement.tabIndex = e.minuteElement.tabIndex = -1,
        e.hourElement.value = O(e.latestSelectedDateObj ? e.latestSelectedDateObj.getHours() : e.config.time_24hr ? n.hours : k(n.hours)),
        e.minuteElement.value = O(e.latestSelectedDateObj ? e.latestSelectedDateObj.getMinutes() : n.minutes),
        ...
        e.config.enableSeconds) {
            ...
            e.secondElement = l.getElementsByTagName("input")[0],
            e.secondElement.value = O(e.latestSelectedDateObj ? e.latestSelectedDateObj.getSeconds() : n.seconds),
            ...
            e.timeContainer.appendChild(y("span", "flatpickr-time-separator", ":")),
            e.timeContainer.appendChild(l)
        }
        return e.config.time_24hr || (e.amPM = y("span", "flatpickr-am-pm", e.l10n.amPM[H((e.latestSelectedDateObj ? e.hourElement.value : e.config.defaultHour) > 11)]),
    ...
    function Re() {
        if (e.weekdayContainer) {
            var n = e.l10n.firstDayOfWeek
              , t = en(e.l10n.weekdays.shorthand);
    ...
    function Ee(n, t) {
        ...
        i < 0 && e._hidePrevMonthArrow === !0 || i > 0 && e._hideNextMonthArrow === !0 || (e.currentMonth += i,
    ...
    function dn(n, t) {
        ...
        t === !0 && (e.currentYear = e._initialDate.getFullYear(),
    ...
    function Se(n) {
        if (e.isOpen && !e.config.inline) {
            var t = L(n)
              ...
              , l = !o && !i && !ie(n.relatedTarget)
              , s = !e.config.ignoredFocusElements.some(function(v) {
                return v.contains(t)
            });
            l && s && (e.config.allowInput && e.setDate(e._input.value, !1, e.config.altInput ? e.config.altFormat : e.config.dateFormat),
            e.timeContainer !== void 0 && e.minuteElement !== void 0 && e.hourElement !== void 0 && e.input.value !== "" && e.input.value !== void 0 && p(),
            e.close(),
    ...
    function G(n, t) {
        ...
        if (e.config.minDate && o && j(o, e.config.minDate, t !== void 0 ? t : !e.minDateHasTime) < 0 || e.config.maxDate && o && j(o, e.config.maxDate, t !== void 0 ? t : !e.maxDateHasTime) > 0)
            return !1;
    ...
    function We(n) {
        var t = L(n)
          ...
          , l = e.isOpen && (!o || !i)
          , s = e.config.inline && i && !o;
        if (n.keyCode === 13 && i) {
            if (o)
                return e.setDate(e._input.value, !0, t === e.altInput ? e.config.altFormat : e.config.dateFormat),
                e.close(),
                t.blur();
            e.open()
        } else if (ie(t) || l || s) {
            ...
            case 8:
            case 46:
                i && !e.config.allowInput && (n.preventDefault(),
                e.clear());
                break;
            case 37:
            case 39:
            ...
            case 40:
                ...
                de(e.currentYear - f),
                re(B(1), 0)) : v || re(void 0, f * 7) : t === e.currentYearElement ? de(e.currentYear - f) : e.config.enableTime && (!v && e.hourElement && e.hourElement.focus(),
                p(n),
                e._debouncedChange());
                break;
            case 9:
                if (v) {
                    ...
                    !e.config.noCalendar && e.daysContainer && e.daysContainer.contains(t) && n.shiftKey && (n.preventDefault(),
                    e._input.focus());
                break;
            default:
                break
    ...
    function ge(n, t) {
        if (t === void 0 && (t = "flatpickr-day"),
        !(e.selectedDates.length !== 1 || n && (!n.classList.contains(t) || n.classList.contains("flatpickr-disabled")))) {
            for (var i = n ? n.dateObj.getTime() : e.days.firstElementChild.dateObj.getTime(), o = e.parseDate(e.selectedDates[0], void 0, !0).getTime(), l = Math.min(i, e.selectedDates[0].getTime()), s = Math.max(i, e.selectedDates[0].getTime()), v = !1, d = 0, C = 0, f = l; f < s; f += Xe.DAY)
                G(new Date(f), !0) || (v = v || f > l && f < s,
                f < o && (!d || f > d) ? d = f : f > o && (!C || f < C) && (C = f));
            ...
            g.forEach(function(E) {
                ...
                if (oe) {
                    ...
                    ["inRange", "startRange", "endRange"].forEach(function(ee) {
                ...
                n !== void 0 && (n.classList.add(i <= e.selectedDates[0].getTime() ? "startRange" : "endRange"),
                o < i && R === o ? E.classList.add("startRange") : o > i && R === o && E.classList.add("endRange"),
                R >= d && (C === 0 || R <= C) && Ze(R, o, i) && E.classList.add("inRange"))
            })
        }
    }
    function pn() {
    ...
    function vn(n, t) {
        if (t === void 0 && (t = e._positionElement),
        e.isMobile === !0) {
            if (n) {
                n.preventDefault();
                var i = L(n);
        ...
        var o = e.isOpen;
        e.isOpen = !0,
        o || (e.calendarContainer.classList.add("open"),
        e._input.classList.add("active"),
        S("onOpen"),
        he(t)),
        e.config.enableTime === !0 && e.config.noCalendar === !0 && e.config.allowInput === !1 && (n === void 0 || !e.timeContainer.contains(n.relatedTarget)) && setTimeout(function() {
    ...
    function Ke(n) {
        return function(t) {
            ...
            i !== void 0 && (e[n === "min" ? "minDateHasTime" : "maxDateHasTime"] = i.getHours() > 0 || i.getMinutes() > 0 || i.getSeconds() > 0),
            e.selectedDates && (e.selectedDates = e.selectedDates.filter(function(l) {
                return G(l)
            }),
            !e.selectedDates.length && n === "min" && I(i),
            J()),
            e.daysContainer && (qe(),
            i !== void 0 ? e.currentYearElement[n] = i.getFullYear().toString() : e.currentYearElement.removeAttribute(n),
            e.currentYearElement.disabled = !!o && i !== void 0 && o.getFullYear() === i.getFullYear())
        }
    }
    function Dn() {
        var n = ["wrap", "weekNumbers", "allowInput", "allowInvalidPreload", "clickOpens", "time_24hr", "enableTime", "noCalendar", "altInput", "shorthandCurrentMonth", "inline", "static", "enableSeconds", "disableMobile"]
          , t = A(A({}, JSON.parse(JSON.stringify(a.dataset || {}))), r)
          , i = {};
        ...
        t.mode === "time" && (e.config.noCalendar = !0,
        e.config.enableTime = !0),
        Object.assign(e.config, i, t);
        ...
        for (var d = 0; d < e.config.plugins.length; d++) {
            ...
            for (var f in C)
                De.indexOf(f) > -1 ? e.config[f] = Me(C[f]).map(D).concat(e.config[f]) : typeof t[f] > "u" && (e.config[f] = C[f])
        }
        t.altInputClass || (e.config.altInputClass = Be().className + " " + e.config.altInputClass),
        S("onParseConfig")
    }
    function Be() {
    ...
    function Ue() {
        typeof e.config.locale != "object" && typeof T.l10ns[e.config.locale] > "u" && e.config.errorHandler(new Error("flatpickr: invalid locale " + e.config.locale)),
        e.l10n = A(A({}, T.l10ns.default), typeof e.config.locale == "object" ? e.config.locale : e.config.locale !== "default" ? T.l10ns[e.config.locale] : void 0),
        V.D = "(" + e.l10n.weekdays.shorthand.join("|") + ")",
        V.l = "(" + e.l10n.weekdays.longhand.join("|") + ")",
        V.M = "(" + e.l10n.months.shorthand.join("|") + ")",
        V.F = "(" + e.l10n.months.longhand.join("|") + ")",
        V.K = "(" + e.l10n.amPM[0] + "|" + e.l10n.amPM[1] + "|" + e.l10n.amPM[0].toLowerCase() + "|" + e.l10n.amPM[1].toLowerCase() + ")";
        var n = A(A({}, r), JSON.parse(JSON.stringify(a.dataset || {})));
        n.time_24hr === void 0 && T.defaultConfig.time_24hr === void 0 && (e.config.time_24hr = e.l10n.time_24hr),
        e.formatDate = Pe(e),
        e.parseDate = we({
            config: e.config,
            l10n: e.l10n
    ...
    function he(n) {
        ...
        if (e.calendarContainer !== void 0) {
            ...
            var t = n || e._positionElement
              ...
              , C = window.innerHeight - d.bottom
              , f = s === "above" || s !== "below" && C < i && d.top > i
              , g = window.pageYOffset + d.top + (f ? -i - 2 : t.offsetHeight + 2);
            if (Y(e.calendarContainer, "arrowTop", !f),
            Y(e.calendarContainer, "arrowBottom", f),
            !e.config.inline) {
                var E = window.pageXOffset + d.left
                  , U = !1
                  , R = !1;
                v === "center" ? (E -= (o - d.width) / 2,
                U = !0) : v === "right" && (E -= o - d.width,
                R = !0),
                Y(e.calendarContainer, "arrowLeft", !U && !R),
                Y(e.calendarContainer, "arrowCenter", U),
                Y(e.calendarContainer, "arrowRight", R);
                var oe = window.document.body.offsetWidth - (window.pageXOffset + d.right)
                  , ee = E + o > window.document.body.offsetWidth
                  , _n = oe + o > window.document.body.offsetWidth;
                if (Y(e.calendarContainer, "rightMost", ee),
                !e.config.static)
                    if (e.calendarContainer.style.top = g + "px",
                    !ee)
                        e.calendarContainer.style.left = E + "px",
                        e.calendarContainer.style.right = "auto";
                    else if (!_n)
                        e.calendarContainer.style.left = "auto",
                        e.calendarContainer.style.right = oe + "px";
                    else {
                        var Oe = bn();
                        if (Oe === void 0)
                            return;
                        var In = window.document.body.offsetWidth
                          , On = Math.max(0, In / 2 - o / 2)
                          , Yn = ".flatpickr-calendar.centerMost:before"
                          , An = ".flatpickr-calendar.centerMost:after"
                          , Nn = Oe.cssRules.length
                          , Pn = "{left:" + d.left + "px;right:auto;}";
                        Y(e.calendarContainer, "rightMost", !1),
                        Y(e.calendarContainer, "centerMost", !0),
                        Oe.insertRule(Yn + "," + An + Pn, Nn),
                        e.calendarContainer.style.left = On + "px",
                        e.calendarContainer.style.right = "auto"
                    }
            }
        }
    ...
    function Je(n) {
        ...
        if (i !== void 0) {
            ...
            e.config.mode === "single")
                ...
                e.latestSelectedDateObj = l,
                e.selectedDates.push(l),
                j(l, e.selectedDates[0], !0) !== 0 && e.selectedDates.sort(function(g, E) {
                    return g.getTime() - E.getTime()
                }));
            if (_(),
            s) {
                var d = e.currentYear !== l.getFullYear();
                e.currentYear = l.getFullYear(),
                e.currentMonth = l.getMonth(),
                d && (S("onYearChange"),
                X()),
                S("onMonthChange")
            }
            ...
            fe(),
            J(),
            !s && e.config.mode !== "range" && e.config.showMonths === 1 ? $(o) : e.selectedDateElem !== void 0 && e.hourElement === void 0 && e.selectedDateElem && e.selectedDateElem.focus(),
    ...
    var pe = {
        ...
        clickOpens: [function() {
            e.config.clickOpens === !0 ? (M(e._input, "focus", e.open),
            M(e._input, "click", e.open)) : (e._input.removeEventListener("focus", e.open),
    ...
    function Mn(n, t) {
        if (n !== null && typeof n == "object") {
            ...
            for (var i in n)
                pe[i] !== void 0 && pe[i].forEach(function(o) {
                    return o()
                })
        } else
            e.config[n] = t,
            pe[n] !== void 0 ? pe[n].forEach(function(o) {
                return o()
    ...
    function wn(n, t, i) {
        ...
        n !== 0 && !n || n instanceof Array && n.length === 0)
            return e.clear(t);
        Ve(n, i),
    ...
    function xn() {
        ...
        e._input = e.input,
        e.config.altInput && (e.altInput = y(e.input.nodeName, e.config.altInputClass),
        e._input = e.altInput,
    ...
    function kn() {
        ...
        e.mobileInput = y("input", e.input.className + " flatpickr-mobile"),
        ...
        e.mobileFormatStr = n === "datetime-local" ? "Y-m-d\\TH:i:S" : n === "date" ? "Y-m-d" : "H:i:S",
        ...
        M(e.mobileInput, "change", function(t) {
            e.setDate(L(t).value, !1, e.mobileFormatStr),
            S("onChange"),
            S("onClose")
        })
    }
    ...
    function S(n, t) {
        if (e.config !== void 0) {
            ...
            n === "onChange" && (e.input.dispatchEvent(Fe("change")),
            e.input.dispatchEvent(Fe("input")))
        }
    }
    function Fe(n) {
        var t = document.createEvent("Event");
        return t.initEvent(n, !0, !0),
        t
    }
    function _e(n) {
        for (var t = 0; t < e.selectedDates.length; t++) {
            var i = e.selectedDates[t];
            if (i instanceof Date && j(i, n) === 0)
                return "" + t
        }
        return !1
    }
    ...
    function ve() {
        e.config.noCalendar || e.isMobile || !e.monthNav || (e.yearElements.forEach(function(n, t) {
            var i = new Date(e.currentYear,e.currentMonth,1);
            i.setMonth(e.currentMonth + t),
            e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? e.monthElements[t].textContent = ue(i.getMonth(), e.config.shorthandCurrentMonth, e.l10n) + " " : e.monthsDropdownContainer.value = i.getMonth().toString(),
    ...
    function J(n) {
        ...
        e.input.value = Ie(e.config.dateFormat),
        e.altInput !== void 0 && (e.altInput.value = Ie(e.config.altFormat)),
        n !== !1 && S("onValueUpdate")
    }
    function Tn(n) {
        var t = L(n)
    ...
    function Fn(n) {
        ...
        var l = parseFloat(o.getAttribute("min"))
          ...
          , d = parseInt(o.value, 10)
          , C = n.delta || (t ? n.which === 38 ? 1 : -1 : 0)
          , f = d + v * C;
        if (typeof o.value < "u" && o.value.length === 2) {
            var g = o === e.hourElement
              , E = o === e.minuteElement;
            f < l ? (f = s + f + H(!g) + (H(g) && H(!e.amPM)),
            E && x(void 0, -1, e.hourElement)) : f > s && (f = o === e.hourElement ? f - s - H(!e.amPM) : l,
            E && x(void 0, 1, e.hourElement)),
            e.amPM && g && (v === 1 ? f + d === 23 : Math.abs(f - d) > v) && (e.amPM.textContent = e.l10n.amPM[H(e.amPM.textContent === e.l10n.amPM[0])]),
            o.value = O(f)
        }
    }
    return u(),
    ...
    for (var e = Array.prototype.slice.call(a).filter(function(D) {
        ...
        try {
            if (h.getAttribute("data-fp-omit") !== null)
                continue;
            h._flatpickr !== void 0 && (h._flatpickr.destroy(),
            h._flatpickr = void 0),
            h._flatpickr = Rn(h, r || {}),
            c.push(h._flatpickr)
        } catch (D) {
    ...
    return function(u) {
        return u.config.noCalendar || u.isMobile ? {} : ce({
            onKeyDown: function(h, D, w, p) {
                ...
                u.config.enableTime && p.key === "Tab" && k ? (p.preventDefault(),
                e.focus()) : p.key === "Enter" && F === e && u.close()
            },
            onReady: function() {
                e = u._createElement("div", c + " " + (r.showAlways ? "visible" : "") + " " + r.theme + "Theme", r.confirmText),
                e.tabIndex = -1,
                e.innerHTML,
                e.addEventListener("click", u.close),
                u.calendarContainer.appendChild(e),
                u.loadedPlugins.push("confirmDate")
            }
        }, r.showAlways ? {} : {
            onChange: function(h, D) {
                ...
                if (p) {
                    if (D && !u.config.inline && w && p)
                        return p.classList.add("visible");
...
function Un(a) {
    var r = ke(ke({}, Bn), a);
    return function(e) {
        e.config.dateFormat = r.dateFormat,
        e.config.altFormat = r.altFormat;
        var c = {
        ...
        function h() {
            e.rContainer && (c.monthsContainer = e._createElement("div", "flatpickr-monthSelect-months"),
            c.monthsContainer.tabIndex = -1,
            D(),
            e.rContainer.appendChild(c.monthsContainer),
            e.calendarContainer.classList.add("flatpickr-monthSelect-theme-" + r.theme))
        }
        function D() {
            if (c.monthsContainer) {
                ...
                for (var m = document.createDocumentFragment(), b = 0; b < 12; b++) {
                    ...
                    x.dateObj.getMonth() === new Date().getMonth() && x.dateObj.getFullYear() === new Date().getFullYear() && x.classList.add("today"),
                    x.textContent = an(b, r.shorthand, e.l10n),
                    x.addEventListener("click", k),
                    m.appendChild(x)
                }
                c.monthsContainer.appendChild(m),
                e.config.minDate && e.currentYear === e.config.minDate.getFullYear() ? e.prevMonthNav.classList.add("flatpickr-disabled") : e.prevMonthNav.classList.remove("flatpickr-disabled"),
                e.config.maxDate && e.currentYear === e.config.maxDate.getFullYear() ? e.nextMonthNav.classList.add("flatpickr-disabled") : e.nextMonthNav.classList.remove("flatpickr-disabled")
            }
        }
        function w() {
        ...
        function p() {
            if (e.rContainer && e.selectedDates.length) {
                for (var m = e.rContainer.querySelectorAll(".flatpickr-monthSelect-month.selected"), b = 0; b < m.length; b++)
                    m[b].classList.remove("selected");
        ...
        function F() {
            ...
            if (m && (m = new Date(m),
            m.setFullYear(e.currentYear),
            e.config.minDate && m < e.config.minDate && (m = e.config.minDate),
            e.config.maxDate && m > e.config.maxDate && (m = e.config.maxDate),
            e.currentYear = m.getFullYear()),
            e.currentYearElement.value = String(e.currentYear),
            e.rContainer) {
                var b = e.rContainer.querySelectorAll(".flatpickr-monthSelect-month");
                b.forEach(function(x) {
                    x.dateObj.setFullYear(e.currentYear),
                    e.config.minDate && x.dateObj < e.config.minDate || e.config.maxDate && x.dateObj > e.config.maxDate ? x.classList.add("flatpickr-disabled") : x.classList.remove("flatpickr-disabled")
                })
            }
            p()
        }
        function k(m) {
            ...
            m.stopPropagation();
            var b = Z(m);
            if (b instanceof Element && !b.classList.contains("flatpickr-disabled") && !b.classList.contains("notAllowed") && (_(b.dateObj),
            e.config.closeOnSelect)) {
                var x = e.config.mode === "single"
                  , N = e.config.mode === "range" && e.selectedDates.length === 2;
                (x || N) && e.close()
            }
        }
        function _(m) {
            var b = new Date(e.currentYear,m.getMonth(),m.getDate())
              , x = [];
            switch (e.config.mode) {
            case "single":
                x = [b];
            ...
            case "multiple":
                ...
                break;
            case "range":
                e.selectedDates.length === 2 ? x = [b] : (x = e.selectedDates.concat([b]),
                x.sort(function(N, W) {
        ...
        function K() {
            var m;
            ((m = e.config) === null || m === void 0 ? void 0 : m.mode) === "range" && e.selectedDates.length === 1 && e.clear(!1),
            e.selectedDates.length || D()
        }
        function M() {
            r._stubbedCurrentMonth = e._initialDate.getMonth(),
            e._initialDate.setMonth(r._stubbedCurrentMonth),
            e.currentMonth = r._stubbedCurrentMonth
        }
        function q() {
            r._stubbedCurrentMonth && (e._initialDate.setMonth(r._stubbedCurrentMonth),
            e.currentMonth = r._stubbedCurrentMonth,
            delete r._stubbedCurrentMonth)
        }
        function ae() {
            if (c.monthsContainer !== null)
                for (var m = c.monthsContainer.querySelectorAll(".flatpickr-monthSelect-month"), b = 0; b < m.length; b++)
                    m[b].removeEventListener("click", k)
        }
        return {
            ...
            onValueUpdate: p,
            onKeyDown: P,
            onReady: [M, u, h, w, p, function() {
                e.config.onClose.push(K),
...
function qn() {
    return function(a) {
        function r(D) {
            var w = Z(D);
            if (w.classList.contains("flatpickr-day"))
                for (var p = a.days.childNodes, F = w.$i, k = F / 7, _ = p[7 * Math.floor(k)].dateObj, I = p[7 * Math.ceil(k + .01) - 1].dateObj, P = p.length; P--; ) {
                    var K = p[P]
                      , M = K.dateObj;
        ...
        function e() {
            ...
            D !== void 0 && D.getMonth() === a.currentMonth && D.getFullYear() === a.currentYear && (a.weekStartDay = a.days.childNodes[7 * Math.floor(a.selectedDateElem.$i / 7)].dateObj,
            a.weekEndDay = a.days.childNodes[7 * Math.ceil(a.selectedDateElem.$i / 7 + .01) - 1].dateObj);
        ...
        function c() {
            for (var D = a.days.childNodes, w = D.length; w--; )
                D[w].classList.remove("inRange")
        }
        function u() {
        ...
        return {
            ...
            onClose: c,
            onParseConfig: function() {
                a.config.mode = "single",
                a.config.enableTime = !1,
                a.config.dateFormat = a.config.dateFormat ? a.config.dateFormat : "\\W\\e\\e\\k #W, Y",
                a.config.altFormat = a.config.altFormat ? a.config.altFormat : "\\W\\e\\e\\k #W, Y"
            },
...
function Jn(a) {
    return {
        ...
        get getMode() {
            return localStorage.getItem("theme") ? localStorage.getItem("theme") : (this.mode = this.darkStatus ? "dark" : "light",
            this.mode)
        },
        init: function() {
            ...
            if (this.getMode === "dark") {
                ...
                console.log(e),
                e && (e.href = this.attribs.darkThemeAsset)
            }
            this.attribs.monthSelect ? r.plugins.push(new rn({
                ...
                theme: this.mode
            })) : this.attribs.weekSelect && r.plugins.push(new on({})),
            this.fp = nn(this.$refs.picker, r),
            this.fp.parseDate(this.state, this.packageConfig.dateFormat),
            window.addEventListener("theme-changed", e=>{
                this.mode = e.detail;
                let c;
                this.mode === "dark" ? c = this.attribs.darkThemeAsset : c = this.attribs.themeAsset,
                document.querySelector("#pickr-theme").href = c
            }
            )
        }
    }
