...
it('should return the day before and after if the shift is at night', function () {
    ...
    $expected = [
        new Range(Carbon::parse('2024-12-17 00:00:00'), Carbon::parse('2024-12-17 22:30:00')),
        new Range(Carbon::parse('2024-12-18 06:00:00'), Carbon::parse('2024-12-19 07:59:00')),
    ];
...
it('should return the next sunday if the shift is full weekend', function () {
    ...
    $shift = new Shift(1, 0, 'test', '2024-11-08 16:30:00', '2024-11-09 22:00:00', 0.25, TaskKind::WEEKEND->value, []);
